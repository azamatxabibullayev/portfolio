...
const translations = {
  uz: {
    ...
    work1_desc:       "Mustaqil ishchi sifatida 3 ta Telegram bot va 1 ta to'liq veb-sayt loyihalarini muvaffaqiyatli yakunladim. Turli mijozlar uchun avtomatlashtirish va biznes jarayonlarini optimallashtirishga yo'naltirilgan yechimlar ishlab chiqdim.",
    ...
    proj5_desc:       "Yetkazib berish xizmati API",
  ...
  ru: {
    ...
    work1_desc:       "Как независимый разработчик успешно завершил 3 Telegram-бота и 1 полноценный веб-сайт. Разрабатывал решения для автоматизации и оптимизации бизнес-процессов для различных клиентов.",
    ...
    proj5_desc:       "API службы доставки",
  ...
  en: {
    ...
    work1_company:    "Freelance",
    work1_role:       "Python Developer",
    work1_desc:       "As an independent developer, successfully completed 3 Telegram bots and 1 full website. Delivered automation solutions and optimized business processes for various clients.",
    ...
    proj5_desc:       "Delivery service REST API",
